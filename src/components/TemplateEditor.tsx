          ...
          <div className="col-span-2 space-y-4">
            ...
            <div>
             ...
             <div>
              ...
              <input type="text" name="to" id="to" value={editedTemplate.to} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
            </div>
            <div>
